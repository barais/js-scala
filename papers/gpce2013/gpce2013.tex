...
programming that are efficiently compiled and that can be shared between client and server sides.

Our benchmarks on a real application using these high-level abstractions showed runtime
performances similar to hand-optimized low-level code.
