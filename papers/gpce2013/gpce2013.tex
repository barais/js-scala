...
Our two kinds of benchmarks, (i) micro benchmarks to evaluate on abstraction and (ii) a benchmark on
a real application using these abstractions show performances similar to hand-optimized low-level
code.
