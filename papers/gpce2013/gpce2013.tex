...
We realized two micro-benchmarks involving programs essentially using the selectors DSL and the
...
execution time of the generated JavaScript code. The tests were run on a DELL Latitude E6430 laptop
with 8 GB of RAM, on the Google Chrome v27 Web browser.
...
general APIs (\code{querySelector} and \code{querySelectorAll}). So we directly compared the
