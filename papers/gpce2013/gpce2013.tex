...
We were able to provide high-level abstractions for Web programming, decreasing code complexity and
improving code reuse between client and server sides, while generating efficient low-level code
leveraging both client and server environments.
