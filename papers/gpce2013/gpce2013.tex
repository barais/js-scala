...
Our two kinds of benchmarks, micro benchmarks to evaluate on abstraction and a benchmark on a real
application using these abstractions show performances similar to hand-optimized low-level code.
