...
approach shares the same benefits and limits as embedded DSLs for defining language units. The code
...
appropriate, produce JavaScript code using the specialized API, otherwise they produce  code using
